...
/**
 * Servlet implementation class dschuyentienController
 */
@WebServlet("/dschuyentienController")
public class dschuyentienController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public dschuyentienController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("dsct", xnbo.getdanhsach());
