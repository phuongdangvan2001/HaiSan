...
<tr><h1 align="center" class="text-danger">XÁC NHẬN</h1></tr>	
	<tr>
   				<td width="10">STT </td>
   ...
   <%ArrayList<xacnhanbean> ds= (ArrayList<xacnhanbean>) request.getAttribute("dskh"); 
   int i=0;
   for(xacnhanbean xn: ds){ %>
      ...
      <td> <a href="xacnhanchuyentienController?MaChiTietHD=<%=xn.getMachitiethd()%>">
