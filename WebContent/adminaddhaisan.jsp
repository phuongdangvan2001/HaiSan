...
<body>
	...
	<form action="adminaddhaisan1Controller" method="post" enctype="multipart/form-data" class='form-container'>
		<div class="form-row">
			<div class="form-group col-md-12">
				<label for="inputEmail4">Mã hải sản</label> <input type="text"
					name="ms" name="" class="form-control" id="inputEmail4"
					required="required">
			</div>
			<div class="form-group col-md-12">
				<label for="inputPassword4">Tên hải sản</label> <input name="ts"
			...
			<div class="form-group col-md-6">
				<label for="inputState">Mã loại</label> <select id="inputState"
					name="ml" class="form-control" required="required">
		...
		<button type="submit" class="btn btn-primary" name="btnSave">
			<i class="fa-solid fa-floppy-disk"></i> Thêm hải sản
		</button>
