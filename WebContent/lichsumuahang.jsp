...
<table width="1000" align="center" class="table">
   		...
   		<table  class="table table-hover">
   			<tr><h1 align="center" class="text-danger"> LỊCH SỬ MUA HÀNG </h1></tr>	
   			<tr>
   				<td width="20">STT</td>
   				...
   				<td width="110">Thanh toán</td>
   				<td width="150"> Góp ý</td>
   			</tr>
	   		 <%int i =1;
	   		 ArrayList<lichsumuahangbean> dslsmh = (ArrayList<lichsumuahangbean>)request.getAttribute("dslsmh");   		 
	   		  for(lichsumuahangbean h: dslsmh){%>
	   		  <tr>	    
	   		  	<td><%=i %></td>
	   		    <td>
	   		      <%=h.getTensach() %>
	   		    ...
	   		    <td><%=h.isDamua() == true ? "Rồi" : "Chưa" %> 
	   		    	<%if(h.isDamua() == false){ %> <a href="thanhtoantungdonhangController"><img src="image\pay.png" height="20" width="20"></a><%} %>
	   		    </td>
	   		    <%
	   		    if(h.isDamua() == false){
	   		    %>
	   		    <%} i++;%>
	   		    <td><%=h.getGopy()!= null? h.getGopy() : "Không có góp ý" %></td>
	   		  </tr>
	   		    <%} %>
   		 	</table>
   		 <table class="table table-hover">
